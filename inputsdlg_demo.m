...
%%Can't seem to make more than one checkbox
%Prompt(5,:) = {'OH Endwall' 'OHEndwall',[]};
%Formats(2,4).type = 'check';
%DefAns.OHEndwall = true;
